...
<div class="container">
    ...
    <form>
        <div class="row">
            ...
            <div class="chosen-select col-sm-2">
                <select onchange="disableInputs1()" class="chosen-select form-control select2" id="currencytype">
...
<script>
    ...
    $(document).ready(function(){
        ...
        function updatesymprices(){
            getallsymbolsprices();
            setTimeout(updatesymprices,1*1000);
        }
            ...
            $("#dptable > tbody > tr").each(function(){
                ...
                if(!price2){
                    if(alertoptions == 'Greater Than'){
                        if(fp > price1){
                            // alert1.play();
                            alert(fp + 'Price of ' + symbol + ' is greater than ' + price1);
                        }
                    }
                    else{
                        if(fp < price1){
                            // alert1.play();
                            alert(fp +'Price of ' + symbol + ' is less than ' + price1);
                        }
                    }
                    ...
                    if(alertoptions == 'Inside Channel'){
                        if(fp > price1 && fp < price2){
                            // alert1.play();
                            alert(fp +'Price of ' + symbol + ' is Inside channel ' + price1 + ' & ' + price2);
                        }
                    }
                    else{
                        if(fp < price1 || fp > price2){
                            // alert1.play();
                            alert(fp +'Price of ' + symbol + ' is Outside channel ' + price1 + ' & ' + price2);
                        }
                    }
